...
Public Class viewcustomerOrder
    Public id, you, Cat, Ite, Des, Fla, Pri, Quan, tot, Sto, Sne, ex As String
    ...
    Public Sub save()
        ...
        If rd.Read Then
            ...
            frmOrders.txtItemName.Text = Ite
            frmOrders.txtItem2.Text = Ite
            frmOrders.txtCategories.Text = Cat
            frmOrders.txtDescription.Text = Des
            frmOrders.txtFlavor.Text = Fla
            frmOrders.txtPrice.Text = Pri
            frmOrders.txtQuantity.Text = Quan
            frmOrders.txtTotalPrice.Text = tot
            frmOrders.txtStock.Text = Sto


            frmOrders.txtStockNew.Text = Sne
