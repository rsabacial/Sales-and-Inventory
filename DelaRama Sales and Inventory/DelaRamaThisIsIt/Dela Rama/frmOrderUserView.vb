...
Public Class frmOrderUserView
    ...
    Dim sql As String
    Private Sub frmOrderUserView_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        txtSearch.ResetText()
    ...
    Public Sub save()
        ...
        If rd.Read Then
            ...
            frmOrderUser.txtdown.Text = Name
