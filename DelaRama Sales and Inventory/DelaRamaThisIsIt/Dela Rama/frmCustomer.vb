...
Public Class frmCustomer
    ...
    Private Sub btnSearch_Click(sender As System.Object, e As System.EventArgs) Handles btnSearch.Click
        Try
            ...
            sql = "SELECT CustomerID,Lastname,Firstname,Middlename,Gender,Contact,Address,Email FROM Customers Where Lastname  LIKE '%" & txtSearch.Text.Trim() & "%' or  Firstname LIKE '%" & txtSearch.Text.Trim() & "%'  Order by  Lastname"
            cmd = New SqlCommand(sql, myConn)
            myConn.Open()
            rd = cmd.ExecuteReader
            DataGridEmployee.Rows.Clear()
    ...
    Private Sub frmCustomer_Activated(sender As System.Object, e As System.EventArgs) Handles MyBase.Activated
