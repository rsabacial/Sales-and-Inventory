...
Public Class frmOrders
    ...
    Private Sub txtChange_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtPayment.KeyUp, txtBalance.KeyUp
        gago()
    End Sub
    Private Sub gago()
    ...
    Private Sub txtTotalPrice_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtQuantity.KeyUp, txtPrice.KeyUp
        price()
    End Sub
    ...
    Private Sub txtStockNew_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtQuantity.KeyUp, txtStock.KeyUp
        rs()
    End Sub
    Private Sub rs()
    ...
    Private Sub btnSearchItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchItem.Click
        Try
            ...
            sql = "SELECT ItemID,Categories,ItemName,Description,Flavor,ExpirationDate,Stock,Price FROM Items Where Categories  LIKE '%" & cbSearchItem.Text.Trim() & "%' or  ItemName LIKE '%" & cbSearchItem.Text.Trim() & "%' Order by  ItemName"
            cmd = New SqlCommand(sql, myConn)
            myConn.Open()
            rd = cmd.ExecuteReader
            DataGridView2.Rows.Clear()
    ...
    Private Sub frmOrders_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Activated

    End Sub

    Private Sub txtCategories_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCategories.TextChanged
