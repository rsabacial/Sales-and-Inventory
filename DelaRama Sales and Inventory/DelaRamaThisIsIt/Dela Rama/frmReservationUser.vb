...
Public Class frmReservationUser
    ...
    Private Sub frmReservationUser_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub DisplayRecords()
        ...
        Try
            ...
            sql = "SELECT ReservationID,CustomerName,Address,Contact,DateReserved,DateDeadline,Categories,ItemName,Description,Flavor,Quantity,Price,TotalPrice,Down,Stock,Stocknew From Reservation"
            ...
            While rd.Read
                ...
                If (count = 0) Then
                    ...
                    txtItemName.Text = rd("Categories").ToString
                    txtCategories.Text = rd("ItemName").ToString
    ...
    Private Sub PictureBox5Close_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmMainUser.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub frmReservationUser_Activated(sender As System.Object, e As System.EventArgs) Handles MyBase.Activated
        Try
    ...
    Private Sub txtBalance_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtTotalPrice.KeyUp, txtDown.KeyUp
    ...
    Private Sub btnSearchCustomer_Click(sender As System.Object, e As System.EventArgs) Handles btnSearchCustomer.Click
        frmCustomerReservationUser.ShowDialog()
        ref()
    End Sub
    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        ...
        If (txtCotanct.Text.Trim().Length = 0) Then
            MsgBox("Contact Number is empty!")
        ...
        If (dtpDaRe.Text.Trim().Length = 0) Then
            MsgBox("Date Reserved is empty!")

            dtpDaRe.Focus()
            Return
        End If
        If (dtpDade.Text.Trim().Length = 0) Then
            MsgBox("Date Deadline is empty!")
